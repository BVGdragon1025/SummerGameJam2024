...
public class GameManager : MonoBehaviour
{
    ...
    {
        _levelData.lvlPlagueValue = Mathf.Clamp(value, 0, _maxLvlPlagueValue);
    }

    public void ChangeCurrencyValue(float value)
    {
        _levelData.currency = Mathf.Clamp(value, 0, _maxCurrency);
    }

    public void ChangePlayerPlagueLevel(float value)
    {
        _levelData.playerPlagueValue = Mathf.Clamp(value, 0, _maxPlayerPlagueValue);
    }
